...
void RTC_Show()
{
    if (targetTime < millis()) {
        ...
        tft.setTextColor(TFT_RED, TFT_BLACK);
        tft.setCursor (6, 0);
        tft.print("Fuck this!"); // This uses the standard ADAFruit small font

        tft.setTextColor(TFT_GREENYELLOW, TFT_BLACK);
        tft.setCursor (64, 0);
        tft.print("Happy New Year!"); // This uses the standard ADAFruit small font
        ...
        if (omm != mm) { // Only redraw every minute to minimise flicker
            ...
            tft.setTextColor(0xF81F, TFT_BLACK); // Orange
            omm = mm;
